...
var gameActive : bool = false; # Only true whilst gameplay is happening. TODO: A nicer way to manage this?
...
func exitToMenu() -> void:
	changeScene("res://scenes/mainMenu/mainMenu.tscn");
...
func _process(_delta: float) -> void:
	...
	if (Input.is_action_just_pressed("game_debugMode")):
		...
		resetScene(); # TODO: Reload menus instead.
